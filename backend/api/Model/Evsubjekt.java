...
public class Evsubjekt {
    ...
    @Basic
    @Column(name = "SUBJ_ID", nullable = true, precision = 0)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(subjId, kmgmid, naziv, ime, priimek, hsMid, naslov, obId, obcina, idPoste, posta, davcna,
                maticna, telSt, email, datZs, status);
    }
}
